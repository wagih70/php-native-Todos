...
session_start();
if (!$_SESSION['token']){
header('Location:/php-native/signup.php');
};
           ...
           <div class="col-8 text-center offset-2 mt-5">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <a href="http://localhost/php-native/show.php?id=<?php echo $row['id'] ?>
                ">
            ...
            <a href="http://localhost/php-native/create.php"><button class="btn btn-dark mt-3">Add Todo</button></a>
